...
enyo.path.addPaths({layout: "/Users/soapdog/prog/mamao-client/enyo/../lib/layout/", onyx: "/Users/soapdog/prog/mamao-client/enyo/../lib/onyx/", onyx: "/Users/soapdog/prog/mamao-client/enyo/../lib/onyx/source/"});
...
modeDiagnostics: !1
}), google.maps.event.addListener(this.map, "dragend", enyo.bind(this, function(e) {
console.log("map drag!"), console.log(this.map.getCenter());
var t = this.map.getCenter();
this.center.lat = t.lat(), this.center.lng = t.lng();
})), this.doMapCreated();
}
},
...
if (this.$.map.hasNode()) {
this.log("map has node");
var t = new google.maps.LatLng(e.latitude, e.longitude), n = "<img src='" + icons[e.tipo].icon + "' />" + "<h2>" + e.titulo + "</h2>", r = new google.maps.InfoWindow({
content: n
});
...
position: t,
draggable: !0,
icon: icons[e.tipo].icon,
map: this.map,
title: e.tipo.title
});
this.map.panTo(t), google.maps.event.addListener(i, "click", function() {
r.open(this.map, i);
}), google.maps.event.addListener(i, "dragend", enyo.bind(this, function() {
console.log("DROP!"), e.latitude = i.position.lat(), e.longitude = i.position.lng(), this.doMarkerMoved(e);
}));
}
},
destroyMap: function() {
...
rendered: function() {
this.inherited(arguments);
var e = JSON.parse(localStorage.getItem("usuario"));
e && e.email && (this.$.email.setValue(e.email), this.$.nome.setValue(e.nome));
},
goBack: function() {
this.doPanelChanged({
panel: "home"
...
login: function() {
var e = this.$.email.getValue(), t = this.$.nome.getValue(), n = {
email: e,
nome: t
};
this.log("salvando " + e + "/" + t);
var r = new enyo.Ajax({
url: mamaoServer + "/novomamoeiro",
handleAs: "json",
method: "POST"
});
r.go(n), r.response(this, function(e, t) {
console.log(t), t.email ? (localStorage.setItem("usuario", JSON.stringify(t)), this.doPanelChanged({
panel: "mapa"
...
kind: "onyx.Toolbar",
classes: "center",
content: "The Feito Na Feira Group",
ontap: "tapLogo"
} ],
rendered: function() {
this.inherited(arguments), navigator.mozApps || (console.log("not moz apps"), this.$.instalarBtn.hide());
var e = JSON.parse(localStorage.getItem("usuario"));
e && e.email && this.doPanelChanged({
panel: "mapa"
});
},
registraUsuario: function(e, t) {
this.doPanelChanged({
panel: "registraUsuario"
});
},
tapLogo: function() {
...
installApp: function() {
var e = location.href.substring(0, location.href.lastIndexOf("/")) + "/manifest.webapp", t = navigator.mozApps.install(e);
t.onsuccess = function(e) {
console.log("app instalado");
}, t.onerror = function() {
console.log("App n\u00e3o instalado: " + t.error.name);
};
}
});
...
var e = JSON.parse(localStorage.getItem("usuario"));
this.log(e), e && e.email && (this.usuario = e), this.log("geolocating..."), this.$.geolocation ? (this.$.gmaps.destroy(), this.$.tapbar.destroy(), this.$.geolocation.getPosition()) : this.createComponent({
name: "geolocation",
...
goBack: function(e, t) {
this.$.gmaps && (this.$.gmaps.destroy(), this.$.geolocation.destroy(), this.$.tapbar.destroy()), this.doPanelChanged({
panel: "home"
});
},
succ: function(e, t) {
...
var n = {}, r = {
data: {}
}, i = this.$.gmaps.getCenterPosition();
switch (t.originator.content) {
case "Foco de Dengue":
n.tipo = "dengue", n.titulo = "Foco de Dengue";
break;
case "Lixo":
n.tipo = "lixo", n.titulo = "Lixo na Rua";
break;
case "Buraco":
n.tipo = "buraco", n.titulo = "Buraco";
}
r.email = this.usuario.email, r.data.tipo = n.tipo, r.data.longitude = i.lng, r.data.latitude = i.lat;
var s = new enyo.Ajax({
...
longitude: i.lng,
titulo: n.titulo
}), s.response(this, function(e, t) {
console.log(t), t ? this.$.gmaps.addMarker(t) : alert("Ocorreu um erro ao gravar o problema.");
});
},
markerMoved: function(e, t) {
console.log("data: ", t);
var n = new enyo.Ajax({
...
titulo: t.titulo
}), n.response(this, function(e, t) {
console.log(t), t ? console.log("problema salvo") : alert("Ocorreu um erro ao atualizar o problema.");
});
},
mapCreated: function() {
...
e.go(), e.response(this, function(e, t) {
var n, r;
console.log(t);
if (t) {
console.log("resultados: " + t.length);
for (n = 0, r = t.length; n < r; n++) console.log(t[n]), t[n].latitude && this.$.gmaps.addMarker(t[n]);
} else alert("Ocorreu um erro ao atualizar o problema.");
});
}
});
...
var mamaoServer = "http://mamaoserver.nodejitsu.com", iconBase = "/assets/img/", icons = {
dengue: {
icon: iconBase + "ico_dengue.png"
},
lixo: {
icon: iconBase + "ico_lixo.png"
},
buraco: {
icon: iconBase + "ico_buraco.png"
}
};
...
t.panel == "mapa" && this.$.mapa.acquirePosition(), this.log("changing panel to " + t.panel + " " + n[t.panel]), this.setIndex(n[t.panel]);
},
...
var n = [ "HomePanel", "RegistrarUsuarioPanel", "MapaPanel", "PositionConfirmPanel", "PositionUpdatePanel" ], r = n[this.index], i = this.getComponents();
if (this.backCalled) {
this.backCalled = !1;
return;
}
